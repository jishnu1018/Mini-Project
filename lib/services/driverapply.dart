...
class driverApply extends StatefulWidget {
  const driverApply({super.key});

  @override
  State<driverApply> createState() => _driverApplyState();
}

class _driverApplyState extends State<driverApply> {
