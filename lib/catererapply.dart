...
class catererOfferScreen extends StatefulWidget {
  const catererOfferScreen({super.key});

  @override
  State<catererOfferScreen> createState() => _catererOfferScreenState();
}

class _catererOfferScreenState extends State<catererOfferScreen> {
