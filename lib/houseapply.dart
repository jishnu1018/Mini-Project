...
class HouseOfferScreen extends StatefulWidget {
  const HouseOfferScreen({super.key});

  @override
  State<HouseOfferScreen> createState() => _HouseOfferScreenState();
}

class _HouseOfferScreenState extends State<HouseOfferScreen> {
