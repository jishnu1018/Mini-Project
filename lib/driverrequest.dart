...
import 'package:joso_app/services/driverapply.dart';
...
class DriverapplyScreen extends StatefulWidget {
  const DriverapplyScreen({Key? key}) : super(key: key);
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => const driverApply()),
                );
              },
