...
import 'package:joso_app/services/catererapply.dart';
...
class CatererapplyScreen extends StatefulWidget {
  const CatererapplyScreen({Key? key}) : super(key: key);

  @override
  State<CatererapplyScreen> createState() => _CatererapplyScreenState();
}

class _CatererapplyScreenState extends State<CatererapplyScreen> {
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => const catererApply()),
                );
              },
