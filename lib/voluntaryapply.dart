...
class voluntaryOfferScreen extends StatefulWidget {
  voluntaryOfferScreen({super.key});

  @override
  State<voluntaryOfferScreen> createState() => _voluntaryOfferScreenState();
}

class _voluntaryOfferScreenState extends State<voluntaryOfferScreen> {
