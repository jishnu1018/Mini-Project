...
import 'services/voluntaryapply.dart';
//import 'package:joso_app/services/cookapply.dart';

class voluntaryapplyScreen extends StatefulWidget {
  const voluntaryapplyScreen({Key? key}) : super(key: key);

  @override
  State<voluntaryapplyScreen> createState() => _voluntaryapplyScreenState();
}

class _voluntaryapplyScreenState extends State<voluntaryapplyScreen> {
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                      builder: (context) => const voluntaryApply()),
                );
              },
